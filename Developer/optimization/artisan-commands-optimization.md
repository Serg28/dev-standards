...
Тема: Оптимизация Artisan-команд Laravel.
Файл составлен для предотвращения нагрузки на сервер из-за некорректного использования конструкторов команд.
...
3. Тяжёлые зависимости в конструкторе создают скрытую нагрузку.
...
даже если сама команда не нужна.
